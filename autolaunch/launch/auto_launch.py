...
#    camerasub_path = os.path.join(get_package_share_directory('camerasub'), 'camerasub', 'subber.py')
#    camerasub = IncludeLaunchDescription(
#        PythonLaunchDescriptionSource(camerasub_path),
